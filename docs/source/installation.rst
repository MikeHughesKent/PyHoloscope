...
If manually downloading the source from Github, rather than installing with pip install from PyPI, you will need to either manually check you have the requirements 
