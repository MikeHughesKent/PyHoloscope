...
class TestPropagatorLut(unittest.TestCase):
    ...
    def test_propagator_lut(self):
        ...
        assert prop_lut.depths[prop_lut.closest_index(self.depth3)] - self.depth3 < semi_spacing
    ...
    def test_holo_class_propagator_lut(self):
        ...
        # Refocus using LUT
        holo.make_propagator_LUT((self.grid_size1, self.grid_size2), depth_range, num_depths)
