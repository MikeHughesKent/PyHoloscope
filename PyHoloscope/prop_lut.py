...
Provides functionality of look-up-able for propagators used by angular spectrum 
...
class PropLUT:
    def __init__(self, imgSize, wavelength, pixelSize, depthRange, nDepths):
        ...
        for idx, depth in enumerate(self.depths):
            self.propTable[idx,:,:] = PyHoloscope.general.propagator(imgSize, wavelength, pixelSize, depth)
